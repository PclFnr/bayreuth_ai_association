  ...
  return (
    <header
      className={clsx(
        ...
        isScrolled
          ? 'dark:bg-zinc-900 dark:backdrop-blur dark:[@supports(backdrop-filter:blur(0))]:bg-zinc-900'
          : 'dark:bg-transparent',
      )}
    >
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
        ...
        <Link href="https://github.com/AndreasKarasenko/scikit-ollama" className="group" aria-label="GitHub">
        {/* COMMENT: GITHUB ICON */}
